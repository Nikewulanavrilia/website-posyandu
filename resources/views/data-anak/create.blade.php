                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3 d-flex flex-column">
                                                ...
                                                <input type="text" class="form-input" name="nama_anak" id="nama_anak" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3 d-flex flex-column">
                                                ...
                                                <input type="text" class="form-input" name="tempat_lahir_anak" id="tempat_lahir_anak" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3 d-flex flex-column">
