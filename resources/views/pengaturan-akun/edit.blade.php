                ...
                <div class="col-12 mt-2">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {!! csrf_field() !!}
                            {!! isset($pengaturan_akun) ? method_field('PUT') : '' !!}
                            ...
                            <input type="text" class="form-input" name="name" id="namaLengkap" value="{{ isset($pengaturan_akun) ? $pengaturan_akun->name : '' }}"required>
                                ...
                                <div class="mb-3 d-flex flex-column">
                                    ...
                                    <input type="text" class="form-input datepicker" name="email"
                                        id="email" value="{{ isset($pengaturan_akun) ? $pengaturan_akun->email : '' }}"required>
                                </div>
                                <div class="mb-3 d-flex flex-column">
                                    <label for="password" class="col-12 text-primary">Password</label>
                                    <input type="text" class="form-input datepicker" name="password"
                                        id="password" value="{{ isset($pengaturan_akun) ? $pengaturan_akun->password : '' }}"required>
                                </div>
                                <div class="mb-3 d-flex flex-column">
