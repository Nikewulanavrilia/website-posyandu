<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css"
    integrity="sha384-ezfkL5HFb8VO1QFtH4tUwbiRpPbyiZhZ4I1W9DI9NXIv6fuHeMwAEdmP7FGUmNG3" crossorigin="anonymous">
...
.asColorPicker-input:-moz-focusring,
.dataTables_wrapper select:-moz-focusring,
.jsgrid .jsgrid-table .jsgrid-filter-row input:-moz-focusring[type="text"],
.jsgrid .jsgrid-table .jsgrid-filter-row select:-moz-focusring,
.jsgrid .jsgrid-table .jsgrid-filter-row input:-moz-focusring[type="number"],
...
.jsgrid .jsgrid-table .jsgrid-filter-row input[type="date"][type="text"],
.jsgrid .jsgrid-table .jsgrid-filter-row input[type="date"][type="number"],
...
.input-group-prepend .swal2-modal .swal2-buttonswrapper .swal2-styled:focus,
.swal2-modal .swal2-buttonswrapper .input-group-prepend .swal2-styled:focus,
...
.fc .asColorPicker-wrap > .input-group-prepend > button,
...
.wizard > .actions .asColorPicker-wrap > .input-group-prepend > a,
...
.fc .asColorPicker-wrap > .input-group-append > button,
...
.ml-0,
.rtl .preview-list .preview-item .preview-thumbnail img i,
...
.sidebar-grdient-dark {
    ...
    background: -webkit-gradient(
        ...
        left bottom,
        color-stop(0%, #6a008a),
        color-stop(20%, #6a008a),
        color-stop(100%, #fa0053)
    );
...
.btn.get-started-btn,
.fc button.get-started-btn,
.ajax-upload-dragdrop .get-started-btn.ajax-file-upload,
.swal2-modal .swal2-buttonswrapper .get-started-btn.swal2-styled,
.wizard > .actions a.get-started-btn {
    font-size: 0.75rem;
...
.wizard > .actions a:not(.btn-light):not(.btn-secondary) {
    color: #ffffff;
}
.btn-primary:not(.btn-light):not(.btn-secondary):hover,
.wizard > .actions a:not(.btn-light):not(.btn-secondary):hover,
.btn-primary:not(.btn-light):not(.btn-secondary):focus,
.wizard > .actions a:not(.btn-light):not(.btn-secondary):focus,
.btn-primary:not(.btn-light):not(.btn-secondary):active,
.wizard > .actions a:not(.btn-light):not(.btn-secondary):active {
    color: #ffffff;
}
.btn-primary:not(.btn-light):not(.btn-secondary):focus,
.wizard > .actions a:not(.btn-light):not(.btn-secondary):focus,
...
.btn-secondary:not(.btn-light):not(.btn-secondary):hover,
.btn-secondary:not(.btn-light):not(.btn-secondary):focus,
.btn-secondary:not(.btn-light):not(.btn-secondary):active {
    color: #ffffff;
}
.btn-secondary:not(.btn-light):not(.btn-secondary):focus,
.btn-secondary:not(.btn-light):not(.btn-secondary):active {
...
.btn-success:not(.btn-light):not(.btn-secondary):hover,
...
.btn-info:not(.btn-light):not(.btn-secondary):hover,
.btn-info:not(.btn-light):not(.btn-secondary):focus,
.btn-info:not(.btn-light):not(.btn-secondary):active {
    color: #ffffff;
}
.btn-info:not(.btn-light):not(.btn-secondary):focus,
.btn-info:not(.btn-light):not(.btn-secondary):active {
...
.btn-warning:not(.btn-light):not(.btn-secondary):hover,
.btn-warning:not(.btn-light):not(.btn-secondary):focus,
.btn-warning:not(.btn-light):not(.btn-secondary):active {
    color: #ffffff;
}
.btn-warning:not(.btn-light):not(.btn-secondary):focus,
.btn-warning:not(.btn-light):not(.btn-secondary):active {
...
.btn-danger:not(.btn-light):not(.btn-secondary):hover,
...
.btn-light:not(.btn-light):not(.btn-secondary):hover,
.btn-light:not(.btn-light):not(.btn-secondary):focus,
.btn-light:not(.btn-light):not(.btn-secondary):active {
    color: #ffffff;
}
.btn-light:not(.btn-light):not(.btn-secondary):focus,
.btn-light:not(.btn-light):not(.btn-secondary):active {
...
.btn-dark:not(.btn-light):not(.btn-secondary):hover,
.btn-dark:not(.btn-light):not(.btn-secondary):focus,
.btn-dark:not(.btn-light):not(.btn-secondary):active {
    color: #ffffff;
}
.btn-dark:not(.btn-light):not(.btn-secondary):focus,
.btn-dark:not(.btn-light):not(.btn-secondary):active {
...
.select2-container--default
    .select2-selection--single
    .form-control-lg.select2-search__field,
...
.navbar .form-control,
.navbar .asColorPicker-input,
.navbar .dataTables_wrapper select,
.dataTables_wrapper .navbar select,
.navbar .jsgrid .jsgrid-table .jsgrid-filter-row input[type="text"],
.jsgrid .jsgrid-table .jsgrid-filter-row .navbar input[type="text"],
.navbar .jsgrid .jsgrid-table .jsgrid-filter-row select,
.jsgrid .jsgrid-table .jsgrid-filter-row .navbar select,
.navbar .jsgrid .jsgrid-table .jsgrid-filter-row input[type="number"],
.jsgrid .jsgrid-table .jsgrid-filter-row .navbar input[type="number"],
.navbar .select2-container--default .select2-selection--single,
.select2-container--default .navbar .select2-selection--single,
.navbar
    .select2-container--default
    .select2-selection--single
    .select2-search__field,
...
.navbar .asColorPicker-input:focus,
.navbar .dataTables_wrapper select:focus,
.dataTables_wrapper .navbar select:focus,
.navbar .jsgrid .jsgrid-table .jsgrid-filter-row input:focus[type="text"],
.jsgrid .jsgrid-table .jsgrid-filter-row .navbar input:focus[type="text"],
.navbar .jsgrid .jsgrid-table .jsgrid-filter-row select:focus,
.jsgrid .jsgrid-table .jsgrid-filter-row .navbar select:focus,
.navbar .jsgrid .jsgrid-table .jsgrid-filter-row input:focus[type="number"],
.jsgrid .jsgrid-table .jsgrid-filter-row .navbar input:focus[type="number"],
.navbar .select2-container--default .select2-selection--single:focus,
.select2-container--default .navbar .select2-selection--single:focus,
.navbar
    .select2-container--default
    .select2-selection--single
    .select2-search__field:focus,
...
.big {
    ...
    height: 15px;
    border-radius: 15px;
    box-shadow: 0px 0px 10px #0090e7, 0px 0px 20px #0090e7, 0px 0px 30px #0090e7,
        0px 0px 50px #0090e7, 0px 0px 60px #0090e7;
    z-index: 1;
    background-color: #0090e7;
...
@keyframes anim {
    ...
    50% {
        box-shadow: 20px 20px 0 0, -20px -20px 0 0, 20px -20px 0 0,
...
.table .table-dark,
.jsgrid .jsgrid-table .table-dark {
    background: #212529;
}
.table.table-contextual,
.jsgrid .table-contextual.jsgrid-table {
    color: #ffffff;
}
...
.ace_editor {
    ...
    height: 300px;
    width: 100%;
    font: 14px / normal SFMono-Regular, Menlo, Monaco, Consolas,
        "Liberation Mono", "Courier New", monospace;
}
...
.navbar .navbar-menu-wrapper .navbar-nav .nav-item .nav-link .navbar-profile p {
    color: #0F6ECD;
    font-weight: 500;
}
